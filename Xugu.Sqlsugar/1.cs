...
{
    public class Program_CSharpDeamon
    {
        public static string conn_xg = "IP=192.168.5.130;DB=SYSTEM;User=SYSDBA;PWD=SYSDBA;Port=5138;AUTO_COMMIT=on;CHAR_SET=GBK";
        ...
        //批量插入
        public static int rec_num = 100000;
        public static int array_num = 100000;
